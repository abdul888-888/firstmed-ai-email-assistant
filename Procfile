...
worker: exec sh -c 'celery -A app.workers.celery_app.celery_app worker --loglevel=info --concurrency=4'

# Celery Beat (periodic task scheduler)
beat: exec sh -c 'celery -A app.workers.celery_app.celery_app beat --loglevel=info'
