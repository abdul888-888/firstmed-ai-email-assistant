...
class WorkflowService:
    ...
    async def run_message(
        ...
        review = await self.repo.create(
            ...
            subject=subject,
            intent=triage.get("intent").value if hasattr(triage.get("intent"), "value") else str(triage.get("intent", "")),
            urgency=triage.get("urgency").value if hasattr(triage.get("urgency"), "value") else str(triage.get("urgency", "")),
